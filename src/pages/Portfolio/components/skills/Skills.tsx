  ...
  return (
    ...
    <SkillsHeader> 
      <div className='animate__animated animate__backInDown' >
        ...
        <p>As a result, I have gained expertise in a variety of areas, including Agile methodologies, Scrum framework, iOS, Android, web development, Windows development, IT, Genexus, design (Adobe Products), and architecture (Autocad, SketchUp), among other programs that I have learned over the past 10 years to successfully execute projects under my leadership.</p>
      </div>
    </SkillsHeader>
